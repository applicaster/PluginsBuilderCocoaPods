Pod::Spec.new do |s|
  ...
  s.source = {
      "http" => "https://dl.bintray.com/applicaster-ltd/pods/ZappAnalyticsPlugins_Framework_2.2.13_a87db23a34027b1784e0518b913b65f43f6b9829.zip"
  }
  ...
  s.subspec 'Mixpanel' do |mixpanel|
    ...
    mixpanel.dependency 'Mixpanel', '~> 3.2.0'
  end
