Pod::Spec.new do |s|
  ...
  s.license = 'CMPS'
	...
	s.source = {
      "http" => "https://dl.bintray.com/applicaster-ltd/pods/ZAZappApp_Framework_4.5.0_605b8e94435b35a2ddf7130b5147fe6f032bfbe6.zip"
  }
  ...
  s.xcconfig =  {
        'SWIFT_VERSION' => '4.0',
        'GCC_PREPROCESSOR_DEFINITIONS' => '$(inherited) CLOSED_VERSION=1',
        'OTHER_SWIFT_FLAGS' => '$(inherited) -DCLOSED_VERSION=1'
              }

  s.dependency 'ApplicasterSDK', '~> 4.19.0'
  s.dependency 'APCrossmates', '~> 1.7.0'
  s.dependency 'APFeed', '~> 3.11.0'
  ...
  s.dependency 'ZappPushPlugins', '~> 2.2.0'
